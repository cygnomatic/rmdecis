 ...
 */
EulerAngles LargeRuneAiming::LargeRuneAimingImpl::predictFromTrack(ArmorTrack &track, Time predTime) {
...
int LargeRuneAiming::LargeRuneAimingImpl::chooseNextTarget(std::map<int, ArmorTrack> &tracks_map, Time &predTime) {
